  ...
  private static String[] ConvertAsciiToBinary(int[] asciiValues) {
    ...
    private static void ChangePixelsColor(String messageBinary,Pixel[] pixels,boolean isLastCharacter) {
    	...
    	for(int i=0;i<pixels.length-1;i++) {
    		char[] messageBinaryCharacter = new char[] {messageBinary.charAt(messageIndex),messageBinary.charAt(messageIndex+1),
    				                      messageBinary.charAt(messageIndex+2)};
    ...
    return pixelRGBBinary;
      ...
      private static Color GetNewPixelColor(String[] colorBinary) {
    	  ...
    	  return new Color(Integer.parseInt(colorBinary[0],2),Integer.parseInt(colorBinary[1],2),
    			            Integer.parseInt(colorBinary[2],2));
